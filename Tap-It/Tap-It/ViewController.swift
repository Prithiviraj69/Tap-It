...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(patternImage: UIImage(named: "abc.jpg")!)
        
        let alert = UIAlertController(title: "Rules", message: "Tap On Highlighted Box To Earn 10 Point, If u tap On wrong box then u lose 5 Point, Tap Within Given Time, Click Start To Begin!!!", preferredStyle: UIAlertController.Style.alert)
    ...
    @objc private func Timerstart(){
        ...
        if(self.timeleft==0){
            ...
            let action = UIAlertAction(title: "submit", style: .default) { (_) in
                ...
                UserDefaults.standard.setValue(self.score, forKey: "Your Score")
                let vc = ScoreBoardVC()
